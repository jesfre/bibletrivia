...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_QUIZENTRY_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_QUIZENTRY actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_QUIZENTRY actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_QUIZENTRY actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_QUIZENTRY actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_QUIZENTRY actions', async () => {
      const arg = 42666;
