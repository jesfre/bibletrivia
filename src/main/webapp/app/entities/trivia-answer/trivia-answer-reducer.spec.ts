...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TRIVIAANSWER_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_TRIVIAANSWER actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_TRIVIAANSWER actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_TRIVIAANSWER actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_TRIVIAANSWER actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_TRIVIAANSWER actions', async () => {
      const arg = 42666;
