...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TRIVIAQUESTION_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_TRIVIAQUESTION actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_TRIVIAQUESTION actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_TRIVIAQUESTION actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_TRIVIAQUESTION actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_TRIVIAQUESTION actions', async () => {
      const arg = 42666;
