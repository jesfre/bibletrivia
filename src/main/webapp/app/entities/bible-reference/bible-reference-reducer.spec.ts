...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BIBLEREFERENCE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_BIBLEREFERENCE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_BIBLEREFERENCE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_BIBLEREFERENCE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_BIBLEREFERENCE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_BIBLEREFERENCE actions', async () => {
      const arg = 42666;
