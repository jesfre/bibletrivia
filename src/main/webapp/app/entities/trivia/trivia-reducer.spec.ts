...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './trivia.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TRIVIA_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_TRIVIA actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_TRIVIA actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_TRIVIA actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_TRIVIA actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_TRIVIA actions', async () => {
      const arg = 42666;
