...
import com.blogspot.jesfre.bibletrivia.security.*;
import com.blogspot.jesfre.bibletrivia.web.filter.SpaWebFilter;
        ...
        http
            ...
            .authorizeHttpRequests(authz ->
                ...
                authz
                    ...
                    .requestMatchers(mvc.pattern("/game/**")).permitAll()
            )
